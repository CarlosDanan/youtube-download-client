...
const socket = socketIO.connect('http://3.15.86.191:4000/');
...
function App() {
  ...
  useEffect(() => {
    //'info-ready' event from server
    //Get video title and video total duration from server
      ...
      {ready &&
        <div className='player' >
          <video id="video1" ref={videoRef} className="video" >
            <source src={'http://3.15.86.191:4000/get_video/' + countString} type="video/mp4"></source>
          </video>
